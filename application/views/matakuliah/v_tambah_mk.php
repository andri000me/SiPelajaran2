<div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
              <br>
              <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>kelola_matakuliah/tambah_mk_proses">
                  <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Kode MK</label>
                      <div class="col-md-2 col-sm-2 col-xs-4">
                          <input class="form-control" name="kode_matkul" placeholder="Kode Mata kuliah" type="text">
                      </div>
                  </div>
                  <div class="form-group">
