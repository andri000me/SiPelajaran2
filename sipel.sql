...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2017 at 11:24 AM
...
(1, '1234', 'Anang', '0998766', 'Subang', 1),
(2, 'TEST', 'Dosen', '09876655', 'Subang', 2),
(3, NULL, 'Syarif', '098763', 'Bandung', 4),
(4, NULL, 'Bambang', '9304758g', 'Bandung', 5),
(5, NULL, 'Dodol Maryato', '098766', 'Bandung', 6),
...
INSERT INTO `tb_jadwal` (`id_jadwal`, `jam`, `id_matakuliah`, `id_dosen`, `id_hari`, `id_ruangan`, `id_kelas`) VALUES
(1, '15:28:00', 1, 2, 1, 1, 1),
(2, '01:00:00', 2, 3, 2, 2, 2);
...
(6, 'test', '098f6bcd4621d373cade4e832627b4f6', '2', 'dosen.png'),
...
--
ALTER TABLE `tb_kelas`
  MODIFY `id_kelas` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
